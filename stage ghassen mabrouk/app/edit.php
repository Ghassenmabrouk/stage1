...
while ($row=mysqli_fetch_assoc($res))
{
   ...
   <header>
	...
	<img src="data:image/jpeg;base64,<?php echo base64_encode($row ['picture']); ?>" width='200' height='200' >
        ...
        <input type="file" id="profile-pic" name="pic" accept="image/jpeg" value="C:\wamp64\www\ghassen mabrouk dsi 3.3\copy\Nouveau dossier\def.jpg">
        
        <label for="name">Name</label>
        <input type="text" id="name" name="name" value="<?php echo $row ['nom'];?>" required>
        
        <label for="email">Email</label>
        <input type="email" id="email" name="email" value="<?php echo $row ['gmail'];?>" required>
        
        <label for="country">country:</label>
        <input type="country" id="country" name="country" value="<?php echo $row ['country'];?>" required>
        
        
        <label for="phone">Phone Number</label>
        <input type="tel" id="phone" name="number" value="<?php echo $row ['number'];?>" required>
        ...
        <input type="password" id="password" name="password" value="<?php echo $row ['pass'];?>" required>
